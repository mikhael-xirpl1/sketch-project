...
#library opencv-python -> pip install opencv-python
...
img = "mybaby.png" #nama file input
...
def dodge(front,back):
    ...
    #kalau gambarnya lebih bedar dari 255 bit/px maka akan diconvert jadi 255
    final_sketch [final_sketch>255]=255
    final_sketch [back==255]=255
    
    return final_sketch.astype('uint8')

#untuk read gambar yang dipilih diawal
...
r = dodge(blur,gray)
#convert gambarnya (dengan mengaplikasikan blur & black white tadi)

cv2.imwrite("mybaby.png", r) # untuk menghasilkan output gambar